...
public class DeviceAnalysis extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Colorimetric Device Analysis Tool");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeviceAnalysis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeviceAnalysis().setVisible(true);
            }
        });
    }
