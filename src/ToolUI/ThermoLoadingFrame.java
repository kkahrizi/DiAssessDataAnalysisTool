...
public class ThermoLoadingFrame extends javax.swing.JFrame implements FileFilter {
    ...
    public int baselineCycleStart;
    public int baselineCycleEnd;
    ...
    public ArrayList<qPCRDataPoint> allqPCRDataPoints;
    public ArrayList<qPCRSample> allqPCRSamples;
    ...
    public ThermoLoadingFrame(File folder, Font officialFont) {
        ...
        initComponents();
        autoAnalyzeCqValues.setEnabled(false);
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (inflectionButton1.isSelected()) {
                        ...
                        try {
                         ...
                         try {
                            baselineCycleStart = Integer.parseInt(baselineStart.getText());
                        } catch (NumberFormatException error) {
                            JOptionPane.showMessageDialog(null, "Please make sure baseline start is an integer");
                            return;
                        }
                         try {
                            baselineCycleEnd = Integer.parseInt(baselineEnd.getText());
                        } catch (NumberFormatException error) {
                            JOptionPane.showMessageDialog(null, "Please make sure baseline start is an integer");
                            return;
                        }
...
//                       }
        ...
        for (int i = 0; i < allData.size(); i++) {
            ...
            for (int j = 0; j < allReplicates.size(); j++) {
                ...
                if (TTRMethod == MIDPOINTMETHOD && !isMeltCurve) {
                    TTR = allReplicates.get(j).getMidpointTTR(secondsPerCycle, amplitudeThreshold, baselineCycleStart, baselineCycleEnd);
        ...
        if (autoAnalyzeCqValues.isSelected() && isMeltCurve == false) {
            allqPCRDataPoints = convertTTRToDataPoints(TTRData);
            AnalyzeqPCRFrame qPCRFrame = new AnalyzeqPCRFrame(allqPCRDataPoints);
        }
    ...
    public ArrayList<qPCRDataPoint> convertTTRToDataPoints(ArrayList<TTRTuple> data) {
        ArrayList<StatLabelCombo> theseStatistics = new ArrayList<StatLabelCombo>();
        ArrayList<qPCRDataPoint> allDataPoints = new ArrayList<qPCRDataPoint>();
        ...
        for (int i = 0; i < theseStatistics.size(); i++) {
            StatLabelCombo thisCombo = theseStatistics.get(i);
            allDataPoints.add(new qPCRDataPoint(thisCombo.getLabel(), thisCombo.getMean(), thisCombo.getStdev()));
        }
...
//            double [] xValueArray = plotReplicate.getSecondDerivativeMinutes(secondsPerCycle,NUMBACK);
            ...
            if (plotTTR) {
                ...
                if (TTRMethod == INFLECTIONPOINTMETHOD) {
                    ...
                    TTR = plotReplicate.getMidpointTTRIndex(amplitudeThreshold, baselineCycleStart, baselineCycleEnd);
...
//        panel.addLinePlot(source,xAxis, yAxis);
    ...
    private void initComponents() {
        ...
        autoAnalyzeCqValues = new javax.swing.JToggleButton();
        jLabel15 = new javax.swing.JLabel();
        jLabel16 = new javax.swing.JLabel();
        jLabel17 = new javax.swing.JLabel();
        baselineEnd = new javax.swing.JTextField();
        baselineStart = new javax.swing.JTextField();
        titleLegendButton = new javax.swing.JToggleButton();
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 10, 660, 700));
        ...
        getContentPane().add(cancelButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 660, 176, -1));

        waitContinueButton.setFont(new java.awt.Font("Tahoma", 0, 36)); // NOI18N
        waitContinueButton.setText("(Wait...)");
        getContentPane().add(waitContinueButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 660, 176, -1));
        ...
        getContentPane().add(CqValueButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 260, 230, 34));
        ...
        getContentPane().add(labelTTRButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 530, 120, 30));
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 610, 270, 35));
        ...
        getContentPane().add(autoSaveButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 615, 120, 30));
        ...
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 310, 110, 30));
        ...
        getContentPane().add(automateIndividuallyButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 340, 200, -1));
        ...
        getContentPane().add(fixedBoundsButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 370, 260, -1));
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 300, 510, 12));
        getContentPane().add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 480, 510, 12));
        ...
        getContentPane().add(minTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 410, 174, -1));

        maxTextField.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        getContentPane().add(maxTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 440, 174, -1));

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel1.setText("MIN");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 410, 35, -1));
        ...
        jLabel9.setText("Baseline End Cycle:");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 180, 160, 20));
        ...
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 570, 350, 30));
        ...
        getContentPane().add(autoOrderButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 575, 120, 30));

        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ToolUI/icons/smallQuestionMark.png"))); // NOI18N
        jLabel12.setToolTipText("When selected, Cq values will be automatically analyzed to produce a standard curve, efficiency, and R^2 values");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 260, 20, 20));
        ...
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 580, 20, 20));
        ...
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 620, 20, 20));
        ...
        getContentPane().add(inflectionButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 220, 230, 34));
        ...
        autoAnalyzeCqValues.setText("MANUAL");
        autoAnalyzeCqValues.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                autoAnalyzeCqValuesActionPerformed(evt);
            }
        });
        getContentPane().add(autoAnalyzeCqValues, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 250, 110, 40));

        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ToolUI/icons/smallQuestionMark.png"))); // NOI18N
        jLabel15.setToolTipText("A difference in ampiltude between baseline and midpoint value smaller than this threshold will result in TTR being the maximum possible for each plot.");
        getContentPane().add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 120, 20, 20));

        jLabel16.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel16.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel16.setText("Amplitude Threshold:");
        getContentPane().add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 120, -1, 20));

        jLabel17.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel17.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel17.setText("Baseline Start Cycle:");
        getContentPane().add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 150, 160, 20));

        baselineEnd.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        baselineEnd.setText("16");
        baselineEnd.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                baselineEndActionPerformed(evt);
            }
        });
        getContentPane().add(baselineEnd, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 180, 170, 20));

        baselineStart.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        baselineStart.setText("10");
        baselineStart.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                baselineStartActionPerformed(evt);
            }
        });
        getContentPane().add(baselineStart, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 150, 170, 20));

        titleLegendButton.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        titleLegendButton.setText("ON");
        titleLegendButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                titleLegendButtonActionPerformed(evt);
            }
        });
        getContentPane().add(titleLegendButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 490, 120, 30));

        jLabel18.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel18.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        jLabel18.setText("Label TTR on Plot:");
        getContentPane().add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 530, 150, 35));
    ...
    private void midpointButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_midpointButtonActionPerformed
        ...
        autoAnalyzeCqValues.setSelected(false);
        autoAnalyzeCqValues.setText("MANUAL");
        amplitudeThresholdField.setText(Integer.toString(DEFAULT_AMPLITUDE_THRESHOLD));
        amplitudeThresholdField.setEditable(true);
        autoAnalyzeCqValues.setEnabled(false);
        baselineStart.setEditable(true);
        baselineStart.setText("10");
        baselineEnd.setEditable(true);
        baselineEnd.setText("16");
    ...
    private void CqValueButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CqValueButtonActionPerformed
        ...
        autoAnalyzeCqValues.setEnabled(true);
        baselineStart.setEditable(false);
        baselineEnd.setEditable(false);
    ...
    private void autoAnalyzeCqValuesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_autoAnalyzeCqValuesActionPerformed
        if (autoAnalyzeCqValues.isSelected() && CqValueButton.isSelected()) {
            autoAnalyzeCqValues.setText("AUTO");
        } else if (autoAnalyzeCqValues.isSelected()) {
            autoAnalyzeCqValues.setText("MANUAL");
        } else {
            autoAnalyzeCqValues.setText("MANUAL");
        }
    }//GEN-LAST:event_autoAnalyzeCqValuesActionPerformed

    private void baselineEndActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_baselineEndActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_baselineEndActionPerformed

    private void baselineStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_baselineStartActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_baselineStartActionPerformed

    private void titleLegendButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_titleLegendButtonActionPerformed
        if (titleLegendButton.isSelected()){
            titleLegendButton.setText("ON");
        } else {
            titleLegendButton.setText("OFF");
        }
    }//GEN-LAST:event_titleLegendButtonActionPerformed
    ...
    private javax.swing.JToggleButton autoAnalyzeCqValues;
    ...
    private javax.swing.JTextField baselineEnd;
    private javax.swing.JTextField baselineStart;
    ...
    private javax.swing.JToggleButton titleLegendButton;
